...
?>
<header><div><h1>Billing</h1><p>What each practice may use, and on what basis. Nothing is charged from here — no payment processor is connected.</p></div></header>
<?php show_flash(); ?>
...
<section>
  ...
  <p class="small notice <?= $proc['connected'] ? 'notice-pass' : 'notice-hold' ?>" style="margin-top:14px;max-width:78ch">
    <b>Payment processor:</b> <?= e($proc['name']) ?>. <?= e($proc['note']) ?>
    Until one is connected, every entitlement on this page is one you granted by hand, and no card is ever charged.
  </p>
</section>
...
<section>
  ...
  <ul class="plain small" style="max-width:78ch">
