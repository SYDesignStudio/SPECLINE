...
- ⚠ not a layer — 65mm comes after a stated result in its sentence, so it reads as working or as an alternative rather than as this build-up; read the clause: 'minimum sand/cement screed or a floating floor d'
